...
export default function WhatsappButton() {
  ...
  const whatsappNumber = '51987654321'; // Ejemplo: Cambia esto al número de J&J
  ...
  className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-3 md:p-4 rounded-full shadow-lg hover:scale-110 transition-transform duration-300 ease-in-out flex items-center justify-center"
